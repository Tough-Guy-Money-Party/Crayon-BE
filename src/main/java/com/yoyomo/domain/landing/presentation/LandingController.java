...
import com.yoyomo.domain.landing.application.dto.request.LandingRequest.NotionSave;
...
public class LandingController {
	...
	public ResponseDto<Void> updateGeneral(@RequestBody LandingRequest.General dto,
	...
	public ResponseDto<LandingResponse.Style> read(@PathVariable String clubId,
		@CurrentUser User user) {
		LandingResponse.Style response = landingStyleManagementUsecase.read(clubId, user);
