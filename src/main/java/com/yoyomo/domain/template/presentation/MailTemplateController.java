...
public class MailTemplateController {
    ...
    public ResponseDto<Page<MailTemplateListResponse>> read(String clubId, @RequestParam Integer page, @RequestParam Integer size){
    ...
    public ResponseDto<MailTemplateGetResponse> read(String templateId){
    ...
    public ResponseDto<String> update(MailTemplateUpdateRequest dto, String templateId, @CurrentUser @Parameter(hidden = true) Long userId){
    ...
    public ResponseDto<String> delete(String templateId, @CurrentUser @Parameter(hidden = true) Long userId){
